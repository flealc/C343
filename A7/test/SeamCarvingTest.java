...
public class SeamCarvingTest {
    ...
    /**      My Test Cases    */
    @Test
    public void mySeamSmall () throws IOException {
        ...
        img.setRGB(3, 2, blue);
        img.setRGB(4, 2, red);
        ImageIO.write(img, "png", new File("try.png"));

        SeamCarving sc1 = new SeamCarving();
        sc1.hash.clear();
        sc1.readImage("try.png");
        System.out.println(sc1.computeEnergy(0, 0));
        System.out.println(sc1.computeEnergy(1, 0));
        System.out.println(sc1.computeEnergy(2, 0));
        System.out.println(sc1.computeEnergy(0, 1));
        System.out.println(sc1.computeEnergy(1, 1));
        System.out.println(sc1.computeEnergy(2, 1));
        System.out.println(sc1.computeEnergy(0, 2));
        System.out.println(sc1.computeEnergy(1, 2));
        System.out.println(sc1.computeEnergy(2, 2));
        System.out.println(sc1.computeEnergy(0, 3));
        System.out.println(sc1.computeEnergy(1, 3));
        System.out.println(sc1.computeEnergy(2, 3));

        Pair<List<Position>, Integer> r = sc1.bestSeam();
        ...
        @Test
        public void myCutSmall () throws IOException {
            SeamCarving sc = new SeamCarving();
    ...
    @Test
    public void myBestSeam () throws IOException {
            SeamCarving sc2 = new SeamCarving();
            sc2.readImage("balloon-sky.jpg");
            int height = sc2.getHeight();
            int width = sc2.getWidth();
            Pair<List<Position>, Integer> r1 = sc2.bestSeam();
    }
